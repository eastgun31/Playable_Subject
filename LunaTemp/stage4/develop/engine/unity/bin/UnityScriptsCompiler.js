...
Bridge.assembly("UnityScriptsCompiler", function ($asm, globals) {
    ...
    Bridge.define("_GameManager", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "_GameManager#init", this ); }

                this.isGameOver = 0;
            }
        },
        methods: {
            /*_GameManager.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "_GameManager#Awake", this ); }

                if (UnityEngine.MonoBehaviour.op_Inequality(_GameManager._instance, null)) {
            ...
            /*_GameManager.Awake end.*/

            /*_GameManager.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "_GameManager#Start", this ); }
 },
            /*_GameManager.Start end.*/

            /*_GameManager.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "_GameManager#Update", this ); }

                if (this.isGameOver >= 8) {
                    this.logo.SetActive(true);
                }
            },
            /*_GameManager.Update end.*/

            /*_GameManager.GameOverTime start.*/
            GameOverTime: function () {
if ( TRACE ) { TRACE( "_GameManager#GameOverTime", this ); }
                ...
                var $enumerator = new Bridge.GeneratorEnumerator(Bridge.fn.bind(this, function () {
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    $enumerator.current = new UnityEngine.WaitForSeconds(45.0);
                                        $step = 1;
                                        return true;
                                }
                                case 1: {
...
if ( TRACE ) { TRACE( "LevelGenerator#Start", this ); }
    ...
    Bridge.define("MatchController", {
        ...
        methods: {
            /*MatchController.MatchCheck start.*/
            MatchCheck: function (index) {
if ( TRACE ) { TRACE( "MatchController#MatchCheck", this ); }

                switch (index) {
                    case 1: 
                        this.MatchAction(this.case1);
                        break;
                    case 2: 
                        this.MatchAction(this.case2);
                        break;
                    case 3: 
                        this.MatchAction(this.case3);
                        break;
                    case 4: 
                        this.MatchAction(this.case4);
                        break;
                    case 5: 
                        this.MatchAction(this.case5);
                        break;
                    case 6: 
                        this.MatchAction(this.case6);
                        break;
                    case 7: 
                        this.MatchAction(this.case7);
                        break;
                    case 8: 
                        this.MatchAction(this.case8);
                        break;
                }
            },
            /*MatchController.MatchCheck end.*/

            /*MatchController.MatchAction start.*/
            MatchAction: function (objs) {
if ( TRACE ) { TRACE( "MatchController#MatchAction", this ); }

                var $t;
                for (var i = 0; i < objs.Count; i = (i + 1) | 0) {
                    var temp1 = objs.getItem(i).GetComponent(MatchObject).id;
                    var temp2 = objs.getItem(i).transform.GetChild(0).GetComponent(MatchObject).id;
                    if (temp1 !== temp2) {
                        break;
                    }
                    if (i === ((objs.Count - 1) | 0)) {
                        this.DestroyObj(objs);
                        ($t = _GameManager._instance).isGameOver = ($t.isGameOver + 1) | 0;
                    }
                }
            },
            /*MatchController.MatchAction end.*/

            /*MatchController.DestroyObj start.*/
            DestroyObj: function (objs) {
if ( TRACE ) { TRACE( "MatchController#DestroyObj", this ); }

                for (var i = 0; i < objs.Count; i = (i + 1) | 0) {
                    UnityEngine.Object.Destroy(objs.getItem(i));
                }
                objs.clear();
            },
            /*MatchController.DestroyObj end.*/
    ...
    Bridge.define("MouseController", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "MouseController#init", this ); }

                this.objectPrevPos = new UnityEngine.Vector3();
                this.mousePos = new UnityEngine.Vector3();
                this.objectPos = new UnityEngine.Vector3();
                this.objectPrevPos = new pc.Vec3( 0.0, 0.0, 0.0 );
                this.isDragging = false;
                this.objectPos = new pc.Vec3( 0.0, -1.3, -1.3 );
                this.zPos = -2.0;
            }
        },
        methods: {
            /*MouseController.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "MouseController#Start", this ); }

                this.mainCam = UnityEngine.Camera.main;
                this.matchController = UnityEngine.Object.FindObjectOfType(MatchController);
            },
            /*MouseController.Start end.*/

            /*MouseController.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "MouseController#Update", this ); }

                this.HandleMouseDown();
                this.HandleMouseUp();
                this.HandleMouseDrag();
            },
            /*MouseController.Update end.*/

            /*MouseController.HandleMouseDown start.*/
            HandleMouseDown: function () {
if ( TRACE ) { TRACE( "MouseController#HandleMouseDown", this ); }

                if (UnityEngine.Input.GetMouseButtonDown(0)) {
                    this.guideText.SetActive(false);
                    var ray = this.mainCam.ScreenPointToRay(UnityEngine.Input.mousePosition);
                    var hit = { v : new UnityEngine.RaycastHit() };
                    if (UnityEngine.Physics.Raycast$1(ray, hit) && hit.v.collider.transform.childCount === 1) {
                        this.objectPrevPos = hit.v.collider.transform.GetChild(0).position.$clone();
                        this.prevParent = hit.v.collider.gameObject;
                        this.selectedObject = hit.v.collider.transform.GetChild(0).gameObject;
                        this.selectedObject.transform.SetParent(null);
                        this.isDragging = true;
                    }
                }
            },
            /*MouseController.HandleMouseDown end.*/

            /*MouseController.HandleMouseUp start.*/
            HandleMouseUp: function () {
if ( TRACE ) { TRACE( "MouseController#HandleMouseUp", this ); }
                ...
                if (UnityEngine.Physics.Raycast$1(ray, hit)) {
                    if (hit.v.collider.transform.childCount === 0) {
                        this.selectedObject.transform.parent = hit.v.collider.transform;
                        this.selectedObject.transform.position = hit.v.collider.transform.position.$clone().add( this.objectPos );
                        this.prevParent = null;
                        this.isDragging = false;
                        this.matchController.MatchCheck(hit.v.collider.GetComponent(MatchObject).id);
                    } else if (hit.v.collider.transform.childCount === 1) {
                        this.selectedObject.transform.parent = this.prevParent.transform;
                        this.selectedObject.transform.position = this.objectPrevPos.$clone();
                        this.isDragging = false;
                    }
            ...
            /*MouseController.HandleMouseUp end.*/

            /*MouseController.HandleMouseDrag start.*/
            HandleMouseDrag: function () {
if ( TRACE ) { TRACE( "MouseController#HandleMouseDrag", this ); }

                if (UnityEngine.Input.GetMouseButton(0) && this.isDragging) {
                    var mouseScreenPos = new pc.Vec3( UnityEngine.Input.mousePosition.x, UnityEngine.Input.mousePosition.y, this.mainCam.WorldToScreenPoint(this.selectedObject.transform.position).z );
                    this.mousePos = this.mainCam.ScreenToWorldPoint(mouseScreenPos);
                    this.mousePos.z = this.zPos;
                    this.selectedObject.transform.position = this.mousePos.$clone();
                }
            },
            /*MouseController.HandleMouseDrag end.*/
...
if ( TRACE ) { TRACE( "Winner#OnTriggerEnter2D", this ); }
    ...
    /*MatchController start.*/
    $m("MatchController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"DestroyObj","t":8,"pi":[{"n":"objs","pt":$n[4].List$1(UnityEngine.GameObject),"ps":0}],"sn":"DestroyObj","rt":$n[0].Void,"p":[$n[4].List$1(UnityEngine.GameObject)]},{"a":1,"n":"MatchAction","t":8,"pi":[{"n":"objs","pt":$n[4].List$1(UnityEngine.GameObject),"ps":0}],"sn":"MatchAction","rt":$n[0].Void,"p":[$n[4].List$1(UnityEngine.GameObject)]},{"a":2,"n":"MatchCheck","t":8,"pi":[{"n":"index","pt":$n[0].Int32,"ps":0}],"sn":"MatchCheck","rt":$n[0].Void,"p":[$n[0].Int32]},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"case1","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"case1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"case2","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"case2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"case3","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"case3"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"case4","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"case4"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"case5","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"case5"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"case6","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"case6"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"case7","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"case7"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"case8","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"case8"}]}; }, $n);
    /*MatchController end.*/

    /*MatchObject start.*/
    $m("MatchObject", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"id","t":4,"rt":$n[0].Int32,"sn":"id","box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*MatchObject end.*/

    /*MouseController start.*/
    $m("MouseController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"HandleMouseDown","t":8,"sn":"HandleMouseDown","rt":$n[0].Void},{"a":1,"n":"HandleMouseDrag","t":8,"sn":"HandleMouseDrag","rt":$n[0].Void},{"a":1,"n":"HandleMouseUp","t":8,"sn":"HandleMouseUp","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"guideText","t":4,"rt":$n[1].GameObject,"sn":"guideText"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"isDragging","t":4,"rt":$n[0].Boolean,"sn":"isDragging","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"mainCam","t":4,"rt":$n[1].Camera,"sn":"mainCam"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"matchController","t":4,"rt":MatchController,"sn":"matchController"},{"a":1,"n":"mousePos","t":4,"rt":$n[1].Vector3,"sn":"mousePos"},{"a":1,"n":"objectPos","t":4,"rt":$n[1].Vector3,"sn":"objectPos"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"objectPrevPos","t":4,"rt":$n[1].Vector3,"sn":"objectPrevPos"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"prevParent","t":4,"rt":$n[1].GameObject,"sn":"prevParent"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"selectedObject","t":4,"rt":$n[1].GameObject,"sn":"selectedObject"},{"a":1,"n":"zPos","t":4,"rt":$n[0].Single,"sn":"zPos","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*MouseController end.*/
    ...
    /*_GameManager start.*/
    $m("_GameManager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"GameOverTime","t":8,"sn":"GameOverTime","rt":$n[2].IEnumerator},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":2,"n":"_instance","is":true,"t":4,"rt":_GameManager,"sn":"_instance"},{"a":2,"n":"isGameOver","t":4,"rt":$n[0].Int32,"sn":"isGameOver","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"logo","t":4,"rt":$n[1].GameObject,"sn":"logo"}]}; }, $n);
    /*_GameManager end.*/
